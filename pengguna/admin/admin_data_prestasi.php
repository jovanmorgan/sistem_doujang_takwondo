...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="prestasi/tambah.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nama_lombah">Nama Lombah :</label>
                                    <input type="text" class="form-control" id="nama_lombah" name="nama_lombah" required>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data prestasi -->
                            <form id="form_edit" action="prestasi/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_prestasi" name="id_prestasi">
                                <div class="form-group">
                                    <label for="nama_lombah">Nama Lomba :</label>
                                    <input type="text" class="form-control" id="editnama_lombah" name="nama_lombah" required>
                                </div>
                                <div class="form-group">
                                    <label for="id_user">Atlet :</label>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_prestasi, nama_lombah, id_user, waktu, lokasi, foto, deskripsi) {
                    deskripsi_data = deskripsi.replace(/<br\s*\/?>/gi, '\n');
                    // Isi data ke dalam form edit
                    document.getElementById('editid_prestasi').value = id_prestasi;
                    document.getElementById('editnama_lombah').value = nama_lombah;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data prestasi</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'prestasi/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'prestasi/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'prestasi/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'prestasi/load_table.php', true);
            xhrTable.send();
        }
    </script>

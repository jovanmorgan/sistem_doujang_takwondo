...
<body translate="no" class="white-content">
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data pembayaran</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center">Jumlah Yang harus Dibayar</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT pembayaran.*, user.nama AS nama_user, tagihan.tanggal_tagihan AS tanggal_tagihan, tagihan.tanggal_jatuh_tempo AS tanggal_jatuh_tempo, tagihan.jumlah_tagihan AS jumlah_tagihan 
                                                FROM pembayaran 
                                                LEFT JOIN user ON pembayaran.id_user = user.id_user 
                                                LEFT JOIN tagihan ON pembayaran.id_tagihan = tagihan.id_tagihan";

                                            // Jika ada kata kunci pencarian, tambahkan klausa WHERE untuk mencocokkan 
                                            if (!empty($search_query)) {
                                                $query .= " WHERE pembayaran.tanggal_pembayaran LIKE '%$search_query%' 
                                                OR user.nama LIKE '%$search_query%' 
                                                OR pembayaran.jumlah_pembayaran LIKE '%$search_query%' 
                                                OR pembayaran.metode_pembayaran LIKE '%$search_query%' 
                                                OR pembayaran.deskripsi LIKE '%$search_query%' 
                                                OR pembayaran.status_pembayaran LIKE '%$search_query%'";
                                            }
                                            ...
                                            if ($result) {
                                                ...
                                                if ($counter == 1) {
                                                    echo "<tr><td class='text-center' colspan='13'><h3>Belum ada data Pembayaran</h3></td></tr>";
                                                }
                                            } else {
                                                echo "<tr><td class='text-center' colspan='13'><h3>Gagal mengambil data dari database</h3></td></tr>";
                                            }
    ...
    <script>
        ...
        // logika untuk menyetujui data 
        function EditStatus(id) {
            swal({
                    title: "Apakah Anda yakin?",
                    text: "Saat data disetujui tidak bisa dibatalkan!",
                    icon: "info",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'pembayaran/edit.php', true);
                        ...
                        xhr.onload = function() {
                            ...
                            if (xhr.status === 200) {
                                ...
                                if (response === 'success') {
                                    ...
                                    swal("Error", "Gagal menyetujui Data.", "error");
                                }
                            } else {
        ...
        function hapus(id) {
            swal({
                    title: "Apakah Anda yakin?",
                    text: "Ketika Anda membatalkan data ini, Data Pembayaran akan secara otomatis dihapus secara permanen!",
                    icon: "warning",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'pembayaran/hapus.php', true);
                        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                        xhr.onload = function() {
                            ...
                            if (xhr.status === 200) {
                                var response = xhr.responseText;
                                if (response === 'success') {
                                    swal("Sukses!", "Data Pembayaran berhasil dihapus.", "success")
                                    loadTable();
                                } else {

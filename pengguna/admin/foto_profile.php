                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nomor Registrasi" name="nomor_registrasi" id="nomor_registrasi" value="<?php echo $admin['nomor_registrasi']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Tingkat Sabuk" name="tingkat_sabuk" id="tingkat_sabuk" value="<?php echo $admin['tingkat_sabuk']; ?>">
                                            </div>
                                        </div>
                                    </div>

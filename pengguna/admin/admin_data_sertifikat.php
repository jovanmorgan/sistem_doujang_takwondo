...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="sertifikat/tambah.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="id_user">Atlet :</label>
                                    <select class="form-control" id="id_user" name="id_user" required>
                                        ...
                                        $query = "SELECT id_user, nama FROM user";
                                ...
                                <div class="form-group">
                                    <label for="type_sertifikat">Jenis Sertifikat :</label>
                                    <select class="form-control" id="type_sertifikat" name="type_sertifikat" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <option value="Sertifikat Prestasi">Sertifikat Prestasi</option>
                                        <option value="Sertifikat Sabuk">Sertifikat Sabuk</option>
                                    </select>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data sertifikat -->
                            <form id="form_edit" action="sertifikat/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_sertifikat" name="id_sertifikat">
                                <div class="form-group">
                                    <label for="id_user">Atlet :</label>
                                    <select class="form-control" id="editid_user" name="id_user" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                        include '../../keamanan/koneksi.php';
                                ...
                                <div class="form-group">
                                    <label for="type_sertifikat">Jenis Sertifikat :</label>
                                    <select class="form-control" id="edittype_sertifikat" name="type_sertifikat" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <option value="Sertifikat Prestasi">Sertifikat Prestasi</option>
                                        <option value="Sertifikat Sabuk">Sertifikat Sabuk</option>
                                    </select>
            ...
            <script>
                function openEditModal(id_sertifikat, id_user, type_sertifikat, waktu, foto, deskripsi) {
                    deskripsi_data = deskripsi.replace(/<br\s*\/?>/gi, '\n');
                    // Isi data ke dalam form edit
                    document.getElementById('editid_sertifikat').value = id_sertifikat;
                    document.getElementById('editid_user').value = id_user;
                    document.getElementById('edittype_sertifikat').value = type_sertifikat;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data sertifikat</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Query SQL untuk mengambil data dari tabel sertifikat
                                            $query = "SELECT sertifikat.*, user.nama AS nama_user FROM sertifikat LEFT JOIN user ON sertifikat.id_user = user.id_user";
                                            // Jika ada kata kunci pencarian, tambahkan klausa WHERE untuk mencocokkan 
                                            if (!empty($search_query)) {
                                                $query .= " WHERE user.nama LIKE '%$search_query%' OR sertifikat.type_sertifikat LIKE '%$search_query%' OR sertifikat.waktu LIKE '%$search_query%' OR sertifikat.deskripsi LIKE '%$search_query%'";
                                            }
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>" . htmlspecialchars($row['type_sertifikat'], ENT_QUOTES) . "</td>";
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_sertifikat'], ENT_QUOTES) . "\",
                                                                \"" . htmlspecialchars($row['id_user'], ENT_QUOTES) . "\",
                                                                \"" . htmlspecialchars($row['type_sertifikat'], ENT_QUOTES) . "\",
                                                                \"" . $waktu_input_data . "\",
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_sertifikat'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'sertifikat/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'sertifikat/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'sertifikat/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'sertifikat/load_table.php', true);
            xhrTable.send();
        }
    </script>

...
<body>
    <div class="hero_area">
        ...
        <div class="text-center">
            <h4 class="judul display-4">Data Sertifikat Sabuk</h4>
            <div class="line"></div>
            <div class="line2"></div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                $query = "SELECT sertifikat.*, user.nama AS nama_user FROM sertifikat LEFT JOIN user ON sertifikat.id_user = user.id_user WHERE sertifikat.id_user = '$id_user' AND sertifikat.type_sertifikat = 'Sertifikat Sabuk'";

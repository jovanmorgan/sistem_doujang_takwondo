...
<body>
    <div class="hero_area">
        ...
        <div class="text-center">
            <h4 class="judul display-4">Data Prestasi</h4>
            <div class="line"></div>
            <div class="line2"></div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                // Query SQL untuk mengambil data dari tabel prestasi sesuai id_user
                $query = "SELECT prestasi.*, user.nama AS nama_user FROM prestasi LEFT JOIN user ON prestasi.id_user = user.id_user WHERE prestasi.id_user = '$id_user'";
                // Jika ada kata kunci pencarian, tambahkan klausa WHERE untuk mencocokkan 
                if (!empty($search_query)) {
                    $query .= " AND (prestasi.nama_lombah LIKE '%$search_query%' OR user.nama LIKE '%$search_query%' OR prestasi.waktu LIKE '%$search_query%' OR prestasi.lokasi LIKE '%$search_query%' OR prestasi.deskripsi LIKE '%$search_query%')";
                }
                ...
                if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "            <h3 class='card-title'>" . htmlspecialchars($row['nama_lombah'], ENT_QUOTES) . "</h3>";
                        echo "            <p class='card-text'>" . htmlspecialchars($row['nama_user'], ENT_QUOTES) . "</p>";
                        echo "            <hr>";
                        echo "            <p class='card-text description'>Deskripsi: " . $deskripsi_sambung . "</p>";
                        echo "            <button class='btn btn-info btn-sm' data-toggle='modal' data-target='#detailModal" . $counter . "'>Selengkapnya</button>";
                        ...
                        <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='detailModalLabel" . $counter . "'>Detail Prestasi</h5>
                                ...
                                <div class='modal-body text-center'>
                                    ...
                                    <h3 class='mt-3'>" . htmlspecialchars($row['nama_lombah'], ENT_QUOTES) . "</h3>
                                    <p><strong>Nama Atlet:</strong> " . htmlspecialchars($row['nama_user'], ENT_QUOTES) . "</p>
                                    <p><strong>Deskripsi:</strong> " . $deskripsi_sambung . "</p>
                                    <p><strong>Waktu:</strong> " . date('d M Y, H:i', strtotime($row['waktu'])) . "</p>
                                    <p><strong>Lokasi:</strong> " . htmlspecialchars($row['lokasi'], ENT_QUOTES) . "</p>
                                </div>

...
// Cek apakah terdapat data yang dikirimkan melalui metode POST pelatih
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE pelatih SET nomor_registrasi='$nomor_registrasi', password='$password', nama='$nama' WHERE id_pelatih='$id_pelatih'";

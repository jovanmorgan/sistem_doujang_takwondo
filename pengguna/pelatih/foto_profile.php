                                ...
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $pelatih['nama']; ?></h5>
                                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_pelatih" id="id_pelatih" value="<?php echo $pelatih['id_pelatih']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="nama" name="nama" id="nama" value="<?php echo $pelatih['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nomor Registrasi</label>
                                                <input type="text" class="form-control" placeholder="Nomor Registrasi" name="nomor_registrasi" id="nomor_registrasi" value="<?php echo $pelatih['nomor_registrasi']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $pelatih['password']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Tingkat Sabuk</label>
                                                <input type="text" class="form-control" placeholder="Tingkat Sabuk" name="tingkat_sabuk" id="tingkat_sabuk" value="<?php echo $pelatih['tingkat_sabuk']; ?>">
                                            </div>
                                        </div>
                                    </div>
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright">
            ...
            </script> Dibuat Oleh AJHARI HUSEN <i class="tim-icons icon-heart-2"></i>
        </div>
    </div>
</footer>
        </div>
